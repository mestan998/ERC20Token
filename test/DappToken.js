...
contract ('DappToken', function(accounts){
    ...
    it('initializes the contractwith correct values', function(){
    ...
    it('handles delegates token transfer', function(){
        return DappToken.deployed().then(function(instance){
            tokenInstance = instance;
            ...
            assert.equal(balance.toNumber(), 90, 'ddeducts the amount from the sending account');
